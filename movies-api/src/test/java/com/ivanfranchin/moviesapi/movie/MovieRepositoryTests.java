...
class MovieRepositoryTests {
    ...
    private Movie persistMovie(String imdbId) {
        Movie movie = Movie.from(new AddMovieRequest(imdbId, "Resident Evil", "Paul W.S. Anderson", 2002));
    ...
    public void testSavePersistsMovieWithAllFields() {
        Movie movie = Movie.from(new AddMovieRequest("tt0120804", "Resident Evil", "Paul W.S. Anderson", 2002));
    ...
    public void testFindAllReturnsAllPersistedMovies() {
        ...
        assertThat(result).extracting("imdbId")
                .containsExactlyInAnyOrder("tt0120804", "tt0119698");
    }
}
